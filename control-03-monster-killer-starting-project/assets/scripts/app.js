...
const MODE_ATTACK = 'ATTACK'; // OR MODE_ATTCK = 0
...
function endRound() {
  ...
  if (currentMonsterHealth <= 0 && currentPlayerHealth > 0) {
    ...
    alert('You lost!');
    writeToLog(LOG_EVENT_MONSTER_ATTACK, 'MONSTER_WON', currentMonsterHealth, currentPlayerHealth);
    reset();
  } else if (currentMonsterHealth <= 0 && currentPlayerHealth <= 0) {
    alert('You have a draw!');
    writeToLog(LOG_EVENT_MONSTER_ATTACK, 'A_DRAW', currentMonsterHealth, currentPlayerHealth);
    reset();
  }
}
...
logBtn.addEventListener('click', printLogHander);
